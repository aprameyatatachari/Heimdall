...
Scroll, swipe-up, Enter, or clicking the control lifts the plate (`DESIGN.md`
§7.4). Shown **once per session**. A deep link to any other route skips it
entirely. Under reduced motion the plate is absent and `/` renders the landing
page directly.
